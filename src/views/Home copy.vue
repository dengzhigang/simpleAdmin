    ...
    <div class="home">
        ...
        <div class="abstract">
            <div class="menu">
                ...
                >
                    <div class="el-submenu__title" style="background: #495265;font-size:18px">
                        <i class="el-icon-s-fold" @click="qiehuan"></i>
                    </div>
                    <el-submenu index="1">
                        <template slot="title">
...
export default {
    ...
    mounted() {
        ...
        // window.open('https://192.168.88.19/Report/ssssdadasd_201910141731088130.zip', '_blank');
        // this.axios
        //     .post(
        //         '/api/html/scanleak/scantasklist/list',
        //         this.qs.stringify({
        //             lang: 'zh_CN',
        //             limit: 30,
        //         }),
        ...
        // this.axios
        //     .post(
        //         '/api/html/autoreport/create/zh_CN',
        //         this.qs.stringify({
        //             taskId: 7,
        //             reportTemplate: 2,
        //             reportType: 2,
        //             report_name: 'ssssdadasd',
        //             report_desc: 'ssssdadasd',
        //             report_title: '漏洞扫描系统',
        //             task_id: 7,
        //             report_type: 2,
        //             report_template: 2,
