<template>
    <div class="system">
        ...
        <el-row>
            <el-col :span="24">
                <div class="footer"><a href="http://www.ncyteng.com" target="_blank">© ncyteng.com, 2021</a></div>
            </el-col>
        </el-row>
    </div>
</template>
...
export default {
    ...
    methods: {
        getDate() {
            ...
            minute = extra(minute);
            second = extra(second);
            this.msg = year + '-' + month + '-' + date + '  ' + hour + ':' + minute + ':' + second;
        },
        brawrisk() {
